                ...
                if not contract_path:
                    ...
                    try:
                        ...
                        if not issues:
                            ...
                            for issue in issues:
                                append_output(output, f"[MISMATCH] Line {issue['line']}: {issue['function']}")
                                append_output(output, f"  • Comment implies: '{issue['trigger_word']}'")
                                append_output(output, "  • Code reality:    Public/External with NO detected modifiers.")
                                append_output(output, "  💡 FIX: Add modifier (onlyOwner, onlyRole, etc.) or change visibility to internal.")
