#!/usr/bin/env python3
"""
Centralized Logging Module for Counterscarp Engine.
...
def setup_logging(
    ...
    Example:
        >>> setup_logging(
        ...     level="DEBUG", format="json", log_file="counterscarp.log"
        ... )
    """
    ...
    with _logging_lock:
        ...
        if level is None:
            level = os.environ.get("COUNTERSCARP_LOG_LEVEL", DEFAULT_LOG_LEVEL)

        if format is None:
            format = os.environ.get("COUNTERSCARP_LOG_FORMAT", DEFAULT_LOG_FORMAT)

        if log_file is None:
            log_file = os.environ.get("COUNTERSCARP_LOG_FILE")
...
def get_log_level() -> str:
    ...
    """
    return os.environ.get("COUNTERSCARP_LOG_LEVEL", DEFAULT_LOG_LEVEL)
...
def get_log_format() -> str:
    ...
    """
    return os.environ.get("COUNTERSCARP_LOG_FORMAT", DEFAULT_LOG_FORMAT)
...
if __name__ == "__main__":
    ...
    test_logger = get_logger("counterscarp.test")
    ...
    test_logger2 = get_logger("counterscarp.test.json")
