#!/usr/bin/env python3
"""
Professional Report Generator for Garrison Engine
...
class AuditReport:
    ...
    Attributes:
        ...
        engine_version: Version of Garrison Engine used.
...
GARRISON_ENGINE_VERSION = "3.4.0"
GARRISON_ENGINE_SEMANTIC_VERSION = "3.4.0"
GARRISON_INFORMATION_URI = "https://github.com/RunTimeAdmin/garrison-engine"
...
def generate_html_report(report: AuditReport, output_path: str, logo_path: Optional[str] = None) -> Optional[str]:
    ...
    if logo_path and Path(logo_path).exists():
        try:
            ...
            logo_html = f'<img src="data:{mime};base64,{logo_b64}" alt="Garrison Engine" style="height: 60px; margin-right: 15px; vertical-align: middle;">'
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="meta">
                ...
                <strong>Engine:</strong> Garrison Engine {report.engine_version}
            </div>
...
"""
    ...
    html += """
        <div class="footer">
            Generated by <strong>Garrison Security Engine</strong> • garrisonsec.com<br>
...
def generate_sarif_report(findings: List[Finding], metadata: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    Raises:
        GarrisonReportError: If report generation fails.
            ...
            "runs": [
                {
                    "tool": {
                        "driver": {
                            ...
                            "version": GARRISON_ENGINE_VERSION,
                            "semanticVersion": GARRISON_ENGINE_SEMANTIC_VERSION,
                            "informationUri": GARRISON_INFORMATION_URI,
                            "rules": rules
                        }
                    },
                    "results": results,
...
def save_sarif_report(findings: List[Finding], output_path: str, metadata: Optional[Dict[str, Any]] = None) -> str:
    ...
    Raises:
        GarrisonReportError: If the file cannot be written.
...
**Engine:** Garrison Engine {report.engine_version}  
...
*Generated by **Garrison Security Engine** • CyberShield Austin / TokenAudit*
"""
...
def create_audit_report(
    ...
    Args:
        ...
        engine_version: Version of the Garrison Engine.
