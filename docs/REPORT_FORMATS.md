...
> **Note:** Prior to v5.0, reports were written directly to the engine root directory (e.g., `audit_report.md`, `audit_report.html`). From v5.0.2 onward, all output is scoped to per-scan subdirectories under `reports/`.
