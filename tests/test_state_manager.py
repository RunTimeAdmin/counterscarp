...
from state_manager import ScanStateManager, StateError, _GarrisonJSONEncoder


# ===========================================================================
# TestGarrisonJSONEncoder
# ===========================================================================

class TestGarrisonJSONEncoder:
    """Tests for the custom JSON encoder."""

    def test_encodes_path(self):
        data = {"p": Path("/some/path")}
        result = json.dumps(data, cls=_GarrisonJSONEncoder)
    ...
    def test_raises_for_unknown_type(self):
        ...
        with pytest.raises(TypeError):
            json.dumps({"obj": Unserializable()}, cls=_GarrisonJSONEncoder)
...
class TestScanStateManagerStartSession:
    ...
    def test_start_session_returns_session_id(self, tmp_path):
        sm = ScanStateManager(garrison_dir=str(tmp_path))
    ...
    def test_start_session_creates_garrison_dir(self, tmp_path):
        new_dir = tmp_path / "nested" / "dir"
        sm = ScanStateManager(garrison_dir=str(new_dir))
...
class TestLoadSession:
    ...
    def test_load_existing_session(self, tmp_path):
        ...
        sm2 = ScanStateManager(garrison_dir=str(tmp_path))
